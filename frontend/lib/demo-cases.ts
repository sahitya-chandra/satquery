export const modes = ["Auto Detect", "Single Image", "Bi-temporal Change", "Optical-SAR Pair"];
export const demoCases = [
  ...
  { id: "fusion", name: "Optical-SAR Fusion", mode: modes[3], files: ["fusion_optical.png", "fusion_sar.png"], query: "Use the optical and SAR images together to identify water and built-up regions." },
